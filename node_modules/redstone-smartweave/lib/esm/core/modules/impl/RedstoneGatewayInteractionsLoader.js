import { Benchmark, LoggerFactory, stripTrailingSlash } from '../../..';
 ...
 */
export class RedstoneGatewayInteractionsLoader {
    ...
    async load(contractId, fromBlockHeight, toBlockHeight) {
        ...
        do {
            ...
            const response = await fetch(`${this.baseUrl}/gateway/interactions?${new URLSearchParams({
