import { BlockHeightCacheResult, BlockHeightKey } from '../../../cache/index';
import { DefaultStateEvaluator, EvalStateResult } from '../../index';
...
export class CacheableStateEvaluator extends DefaultStateEvaluator {
    ...
    async latestAvailableState(contractTxId, blockHeight) {
        ...
        return new BlockHeightCacheResult(stateCache.cachedHeight, stateCache.cachedValue);
    }
