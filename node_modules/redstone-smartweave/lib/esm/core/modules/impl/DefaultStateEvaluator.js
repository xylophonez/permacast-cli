import { Benchmark, deepCopy, EvalStateResult, LoggerFactory, TagsParser } from '../../..';
/**
        ...
        for (let i = 0; i < missingInteractionsLength; i++) {
            ...
            if (isInteractWrite && internalWrites) {
                ...
                if (newState !== null) {
                    ...
                    await this.onStateUpdate(interactionTx, executionContext, new EvalStateResult(currentState, validity));
