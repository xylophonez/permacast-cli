import { ArTransfer, ArWallet, BenchmarkStats, Contract, ContractCallStack, CurrentTx, EvalStateResult, EvaluationOptions, GQLNodeInterface, InteractionResult, SmartWeave, Tags } from '..';
...
export declare class HandlerBasedContract<State> implements Contract<State> {
    ...
    bundleInteraction<Input>(input: Input, tags?: Tags, transfer?: ArTransfer, strict?: boolean): Promise<any | null>;
