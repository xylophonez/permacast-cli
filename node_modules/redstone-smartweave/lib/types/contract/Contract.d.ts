...
export declare type BenchmarkStats = {
    gatewayCommunication: number;
    stateEvaluation: number;
    total: number;
};
/**
...
export interface Contract<State = unknown> {
     ...
     * @param strict - transaction will be posted on Arweave only if the dry-run of the input result is "ok"
     */
    bundleInteraction<Input = unknown>(input: Input, tags?: Tags, transfer?: ArTransfer, strict?: boolean): Promise<any | null>;
    /**
