...
exports.SmartWeaveBuilder = void 0;
...
class SmartWeaveBuilder {
    ...
    build() {
        return new _smartweave_1.SmartWeave(this._arweave, this._definitionLoader, this._interactionsLoader, this._interactionsSorter, this._executorFactory, this._stateEvaluator);
    }
}
